...
function EditMovieFunc(props) {
    ...
    useEffect(() => {
        ...
        if (id > 0) {
            fetch(props.backend + "/v1/movie/" + id)
              .then((response) => {
    ...
    }, [props.history, props.jwt, props.match.params.id, props.backend]);
    ...
    const handleSubmit = (evt) => {
        ...
        fetch(props.backend + "/v1/admin/editmovie", requestOptions)
          ...
          buttons: [
            {
              ...
              onClick: () => {
                ...
                fetch(props.backend + "/v1/admin/deletemovie/" + movie.id,
                  {
                    method: "GET",
                    headers: myHeaders,
                  }
